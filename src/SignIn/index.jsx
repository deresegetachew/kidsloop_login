                    ...
                    <div className="shadow-loginCard p-5 pb-12 rounded-xl border-2  h-auto bg-white">
                        <>
                            ...
                            <div className="flex justify-between items-center mt-4 w-auto">
                                <a href="#" className="text-navy-blue-500 text-sm font-normal cursor">Forgot Password?</a>
                            ...
                            <div className="flex justify-start mt-10">
                                <a href="#" className="text-navy-blue-500 text-sm font-normal">Create an account</a>
