...
export const SignIn = () => {
    ...
    const [formData, setFormData] = useState({ email: { value: '', valid: true }, password: { value: '', valid: true } });
    ...
    return (<>
        ...
        <form onSubmit={(e) => handleSubmit(e)}>
            <div className={`flex items-center justify-center h-screen w-screen  ${darkMode ? 'bg-black text-white' : 'bg-white text-current'} `}>
                <div className="relative flex flex-col items-center justify-center">
                    ...
                    <div className="shadow-loginCard p-5 pb-12 rounded-xl border-2  h-auto">
                        <>
                            ...
                            <div className="flex-1 mb-8">
                                <p className={`text - 2xl font-normal ${darkMode ? 'text-white' : 'text-current'}`}> Sign In</p>
                            </div>
                            ...
                            <div className="flex justify-start mt-10">
                                <a href="#" className={`text-sm font-normal ${!darkMode ? 'text-navy-blue-500' : 'text-kl-blue-500'}`}>Create an account</a>
                    ...
                    <div className="mt-4 flex justify-between text-xs font-normal w-full">
                        <div className="flex justify-start items-center">
                            ...
                            <button type="button" onClick={() => toggleDarkMode()}>
                                <svg className="cursor-pointer h-4 w-4 fill-current text-navy-blue-500 stroke-0 inline-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >
                                    <path d="M0 0h24v24H0V0z" fill="none" /><path d="M20 8.69V6c0-1.1-.9-2-2-2h-2.69l-1.9-1.9c-.78-.78-2.05-.78-2.83 0L8.69 4H6c-1.1 0-2 .9-2 2v2.69l-1.9 1.9c-.78.78-.78 2.05 0 2.83l1.9 1.9V18c0 1.1.9 2 2 2h2.69l1.9 1.9c.78.78 2.05.78 2.83 0l1.9-1.9H18c1.1 0 2-.9 2-2v-2.69l1.9-1.9c.78-.78.78-2.05 0-2.83L20 8.69zM12 18c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6zm0-10c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z" />
                                </svg>
                            </button>
                            ...
                            <div className="relative">
                                ...
                                <svg className="h-4 w-4 fill-current  inline-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
